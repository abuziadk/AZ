Public Class Form1
    ...
    Private Property backtracking As Boolean
    ...
    Private Sub Btn_Solve_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonSolve.Click
        backtracking = True
        For x As Integer = 0 To 8
            For y As Integer = 0 To 8
                grid(x, y) = cell(x, y).Text
